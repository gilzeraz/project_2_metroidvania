...
##
## Plays the hit animation, calculates directional knockback away from the player,
## handles friction decay, and transitions to the next state upon completion.
...
# Sets completion flag when the hurt animation finishes playing

...
##
## Manages frame-based dash triggers, dynamic hitbox scaling during strikes,
## and enforces an export-configurable cooldown period.
...
@export var hitbox_expansion_scale: Vector2 = Vector2(2.5, 2.5)


var _cooldown_timer: float = 0.0
var _hits_done: int = 0
var _original_hitbox_scale: Vector2 = Vector2.ONE
